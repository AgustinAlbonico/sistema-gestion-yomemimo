/**
 * Modal para marcar un gasto como pagado
...
interface MarkAsPaidDialogProps {
    ...
    readonly onConfirm: (expenseId: string, paymentMethodId: string) => void;
...
export function MarkAsPaidDialog({
    ...
    const handleConfirm = () => {
        if (expense && selectedPaymentMethodId) {
            onConfirm(expense.id, selectedPaymentMethodId);
        }
    };
        ...
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Selecciona el método de pago para registrar este gasto
                    </DialogDescription>
                </DialogHeader>
