...
test.describe('Productos', () => {
  ...
  test.describe('Stock', () => {
    test('debe mostrar indicadores de stock bajo si hay productos con poco stock', async ({ page, helpers }) => {
      ...
      // Buscar indicadores de stock bajo (pueden ser badges o iconos)
      const lowStockIndicator = page.locator('[class*="destructive"]')
        .or(page.locator('[class*="warning"]'))
        .or(page.getByText(/bajo stock|sin stock/i));
